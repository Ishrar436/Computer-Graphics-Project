...
// -----------------------------------------
// Panel 2: Rain & Kindness (Umbrella Moment)
// -----------------------------------------
// Keyboard:
//   U = open/close umbrella
//   W = walk forward (boy + girl + umbrella become smaller)
//   X = bring them closer (until they meet, then stop)
//   Up/Down = small umbrella vertical adjust (optional)
//   ESC / Q = exit
